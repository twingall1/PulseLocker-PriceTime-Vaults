...
// ---------------------------------------------------------------------
// PulseLocker Vault Factory (Immutable)
//
// This contract deploys fully-immutable GenericPriceTimeVault instances.
// It supplies each new vault with the correct price-feed pair,
// decimals, and token configuration.
//
// ---------------------------------------------------------------------
// ABOUT FEES
//
// The factory does NOT handle or route any protocol fees. All fee
// behaviour is entirely contained inside GenericPriceTimeVault, where a
// single fixed 0.5% fee is charged *only at withdrawal*.
// --------------------------------------------------------------------
//
// CONTRACT CHARACTERISTICS
//
// - Fully immutable: no owner-only functions, no upgrade paths
// - Deterministic vault deployment using known constructor parameters
...
contract PulseLockerVaultFactory {
